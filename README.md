...
Official PyTorch implementation of TPAMI 2026 paper "[MCPNet++: An Interpretable Classifier via Multi-Level Concept Prototypes]()".

[[`Paper`]()] [[`Website`]()] [[`BibTeX`](#citation)]
...
### Caption Concepts
Before caption the concepts, make sure the concept prototypes and patches are extracted (following the [Protytpes](#visualize-concept-prototypes) and [Patches](#visualize-concept-patches)).
```bash
